...
const LogIn = () => {
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            // --- FIX: Use axiosInstance which has the correct base URL (http://localhost:1000/api/v1) ---
            const response = await axiosInstance.post("/sign-in", Values);
            ...
            // Dispatch the login action WITH the user data from the response
